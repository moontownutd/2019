$(document).ready(function(){
    ...
    var GSSurl2 = "https://spreadsheets.google.com/feeds/list/18j5b5XRHw_0k7xkO5BMfdN73zyGfnQSAfbeTkfMPDTg/2/public/basic?alt=json-in-script&callback=?";

    $.getJSON(GSSurl2,function(data){
        var entry=data.feed.entry;

        for(var i in entry){
            var sGame = entry[i].title.$t,
